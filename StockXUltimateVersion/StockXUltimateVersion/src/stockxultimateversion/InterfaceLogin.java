...
public class InterfaceLogin extends javax.swing.JFrame {
     ...
     UserDatabase usDB = new UserDatabase("users.csv");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         if(usDB.isLogin(email, password) == true)
         {
              setVisible(false);
              InterfaceShop shopInt = new InterfaceShop();
              shopInt.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         String email =  this.jTextField1.getText();
         String password =  this.jPasswordField1.getText();
                if(usDB.isTaken(email) == false)
                {
                usDB.addUser(email, password);
